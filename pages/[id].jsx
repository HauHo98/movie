...
export default function Category() {
	...
	const idQueryParam = router.query.id || '';
	...
	useEffect(() => {
		setLoading(true)
			...
			axios.get(API + 'posts-category/' + idQueryParam + '?page=' + searchQueryParam || '1').then(res => {
