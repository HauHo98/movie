		...
		<>
            ...
            `}>
				<div className="flex flex-col gap-4 sm:flex-row">
					...
					>
						<div>
							<Link href="/" className="flex items-center justify-center gap-2 logo" onClick={()=>{
								setHeader("Trang chủ")
							}}>
