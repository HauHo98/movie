...
async function getData(id) {
	...
	return {movieDetail: resultMovie, castData: castDetail.cast || [], related: dataJson.results || []};
}


export default async function Page({params}) {
	const { movieDetail, castData, related } = await getData(params.id);
	if (!movieDetail) return <div className='flex h-screen w-full items-center justify-center'><span
